...
const MIN_WAIT_SECONDS = 60 * 5; // Thời gian chờ tối thiểu (5 phút)
const MAX_WAIT_SECONDS = 60 * 20; // Thời gian chờ tối đa (20 phút)
// ---------------------------------------------------------------
...
async function main() {
    ...
    if (chrome.alarms) chrome.alarms.create('heartbeat_alarm', { periodInMinutes: 0.5 });
